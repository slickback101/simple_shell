...
/**
 * add_node_list - will add a node to the start of the list
...
/**
 * add_node_end_list - will add a node to the end of the list
 * @head: address of pointer to head node
 * @str: str field of node
 * @num: node index used by history
 *
...
/**
 * rm_node_at_index - will delete node at given index
...
/**
 * free_all_node_list - will free all nodes of a list
